...
(function() {
	...
	document.querySelector('#history-collection').addEventListener(
		'click',
		function(ev) {
			// prettier-ignore
	...
	chrome.history.search(
		{
			...
			maxResults: result, // Defaults to 100
		...
		historyItems => {
			...
			try {
				...
				<h6 class="center-align grey-text">Please try search more specific with more letters.</h6>
				<br>
				`
			}
		},
...
document.querySelector('#search').addEventListener(
	'keyup',
	function(ev) {
		searchUrlList('typeSearch', this.value, 100);
	},
	false,
);
